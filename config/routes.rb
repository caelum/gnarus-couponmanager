AmazonKeyManager::Application.routes.draw do
  devise_for :users

  root :to => "amazon_keys#index"
  
  get  "amazon_keys" => "amazon_keys#index", :as => "amazon_keys"
  post "amazon_keys" => "amazon_keys#create"
